...
const Week: React.FC = () => {
    ...
    return (
        <div className="tw-grid tw-grid-cols-7 tw-border-b tw-border-gray-300 tw-dark:border-gray-700 tw-py-2">
            {DAYS.map(item => (
                <div key={item} className="tw-tracking-wide tw-text-gray-500 tw-text-center">
                    {ucFirst(
                        shortString(
