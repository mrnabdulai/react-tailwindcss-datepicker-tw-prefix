...
const Calendar: React.FC<Props> = ({
    ...
    return (
        <div className="tw-w-full md:tw-w-[296px] md:tw-min-w-[296px]">
            <div className="tw-flex tw-items-center tw-space-x-1.5 tw-border tw-border-gray-300 dark:tw-border-gray-700 tw-rounded-md tw-px-2 tw-py-1.5">
                ...
                {showYears && (
                    <div className="tw-flex-none">
                        ...
                        >
                            <DoubleChevronLeftIcon className="tw-h-5 tw-w-5" />
                        </RoundedButton>
                    </div>
                )}

                <div className="tw-flex tw-flex-1 tw-items-center tw-space-x-1.5">
                    <div className="w-1/2">
                        <RoundedButton
                            onClick={() => {
                                setShowMonths(!showMonths);
                ...
                {showYears && (
                    <div className="tw-flex-none">
                        ...
                        >
                            <DoubleChevronRightIcon className="tw-h-5 tw-w-5" />
                        </RoundedButton>
                    </div>
                )}
            ...
            <div className="tw-px-0.5 sm:tw-px-2 tw-mt-0.5 tw-min-h-[285px]">
                {showMonths && (
